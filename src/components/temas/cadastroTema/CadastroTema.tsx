...
function CadastroTema() {
    ...
    return (
        <Container maxWidth="sm" className="tema-top">
            <form onSubmit={onSubmit}>
                <Typography variant="h3" color="textSecondary" component="h1" align="center" >Formulário de Cadastro Para o Tema</Typography>
